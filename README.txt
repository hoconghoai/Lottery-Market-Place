...
One user can buy many ticket with different number. A number can be bought by many different user. If the number is lucky number, the prize will be divided for that user.
...
Lucky user need to redeem the prize in 90 days from the finish day. After that the prize without redeem will be burn.

90% of total LOT tokens that user buy in the lottery session will be prize, 10% remain will be fee and be burned on finish day.
